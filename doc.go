...
File caching is provided with [github.com/saylorsolutions/cache/file] as an accompanying package.
It's kept separate to prevent bloating your binary with a dependency you won't need if you don't import the package.
...
[NewWithTTL] is similar to New, and is useful for cases where the time to live is determined by the process loading the cached value.
