...
If you need to perform some action in response to the file being changed, then use Value.OnInvalidate on the Value returned from any of these functions.
*/
package file
